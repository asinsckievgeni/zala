...
Ссылки на плейлист и программу передач.
> ⚠️ Ссылки скопировать и вставить в IPTV плеер.
...
## [Программа передач](https://github.com/asinsckievgeni/zala/releases/download/latest/epg.xml.gz)
### Программа передач взята с сайта [https://epg.online/](https://epg.online/epg.xml.gz)
