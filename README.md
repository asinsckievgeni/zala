...
# Программа передач
## 1. [Программа передач с сайта epg.online](https://github.com/asinsckievgeni/zala/epg.xml.gz)
## 2. [Программа передач с сайта epg.one](https://github.com/asinsckievgeni/zala.ru2.xml.gz)
> ⚠️ **Важно**:  Все права на данные принадлежат их владельцам. Используются  **исключительно для личного некоммерческого использования**.
